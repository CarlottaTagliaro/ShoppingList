...
public class ProductCard extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        String html = String.format(" \n"
                ...
                + "                                                 <div class=\"text-info\"><b> Already added: </b><input class=\"amount_added\" type=\"text\" id=\"amount_%d\" readonly></div>\n"
                + "                                             </div>\n"
                + "                                             <div class=\"col-xs-6 col-sm-4\">\n"
                + "                                                 <div class=\"row\"> \n"
                ...
                + "                                                         var value = $(this).val();"
                + "                                                         $(\"#amount_%d\").val($(this).find(\"option[value=\"+value+\"]\").attr(\"amount\"));"
                + "                                                     });"
